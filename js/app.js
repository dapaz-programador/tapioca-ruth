...
var CELULAR_EMPRESA = '559198xxxxxxx';
...
cardapio.metodos = {
    ...
    carregarResumo: () => {
        ...
        $("#cidadeEndereco").html(`${MEU_ENDERECO.cidade}-${MEU_ENDERECO.uf} / ${MEU_ENDERECO.cep} ${MEU_ENDERECO.complemento} / ${MEU_ENDERECO.nome}`);
    ...
    finalizarPedido: () => {
        ...
        if (MEU_CARRINHO.length > 0 && MEU_ENDERECO != null) {
            ...
            texto += `\n\n*Nome para entrega: ${MEU_ENDERECO.nome}*`;
